...
ARG MINICONDA3_INSTALLER_URL=https://repo.anaconda.com/miniconda/Miniconda3-py39_4.12.0-Linux-aarch64.sh
...
RUN wget ${MINICONDA3_INSTALLER_URL} -O /tmp/miniconda.sh
